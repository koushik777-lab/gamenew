    ...
    <div class="right-side">
      <div class="register-box">
       <!-- <div class="dark-toggle" onclick="toggleDarkMode()">🌓 Toggle Theme</div> -->
        ...
        <div class="welcome-text">Signup to Gameonix</div>
        ...
        <div class="checkbox">
          <input type="checkbox" style="margin-right: 8px;"> I agree to privacy policy & terms
        </div>

        <button>Sign up</button>

        <div class="subtext">Already have an account? <a href="./login.php">Sign in instead</a></div>
